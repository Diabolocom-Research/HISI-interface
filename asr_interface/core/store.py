...
class ASRComponentsStore:
    ...
    @property
    def asr_processor(self) -> Optional[ASRProcessor]:
        """Get the current ASR processor."""
        return self._store.get("asr_processor")
    
    @asr_processor.setter
    def asr_processor(self, processor: Optional[ASRProcessor]) -> None:
    ...
    def current_config_id(self, config_id: Optional[str]) -> None:
